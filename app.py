...
def get_jq_shfe_data(
    ...
    """
    从聚宽API获取上期所历史期货数据
    :param symbol: 聚宽期货代码（如RB9999.SHF）
    ...
    try:
        ...
        st.error(f"❌ 聚宽中未找到合约 {symbol}，请检查代码格式（如RB9999.SHF）")
        return None
...
class SHFEFuturesBacktest:
    def __init__(self, data, symbol="RB9999.SHF", initial_capital=1000000):
        self.data = data.copy()
        self.symbol = symbol
